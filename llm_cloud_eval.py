...
4. ОБРАЩЕНИЕ ПО ИМЕНИ В ХОДЕ РАЗГОВОРА
   ...
   а) имя заявителя прозвучало **≥3 раз** в любых репликах диалога (оператор + заявитель суммарно);
   б) любое имя, НЕ совпадающее с именем оператора, прозвучало **≥3 раз** в диалоге суммарно.
   Считай все упоминания имени на протяжении всего разговора, включая начало и конец.
